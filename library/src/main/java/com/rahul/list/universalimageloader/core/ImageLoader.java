 ...
 *******************************************************************************/
package com.rahul.list.universalimageloader.core;
...
import com.rahul.list.universalimageloader.cache.disc.DiskCache;
import com.rahul.list.universalimageloader.cache.memory.MemoryCache;
import com.rahul.list.universalimageloader.core.assist.FailReason;
import com.rahul.list.universalimageloader.core.assist.FlushedInputStream;
import com.rahul.list.universalimageloader.core.assist.ImageSize;
import com.rahul.list.universalimageloader.core.assist.LoadedFrom;
import com.rahul.list.universalimageloader.core.assist.ViewScaleType;
import com.rahul.list.universalimageloader.core.imageaware.ImageAware;
import com.rahul.list.universalimageloader.core.imageaware.ImageViewAware;
import com.rahul.list.universalimageloader.core.imageaware.NonViewAware;
import com.rahul.list.universalimageloader.core.listener.ImageLoadingListener;
import com.rahul.list.universalimageloader.core.listener.ImageLoadingProgressListener;
import com.rahul.list.universalimageloader.core.listener.SimpleImageLoadingListener;
import com.rahul.list.universalimageloader.utils.ImageSizeUtils;
import com.rahul.list.universalimageloader.utils.L;
import com.rahul.list.universalimageloader.utils.MemoryCacheUtils;
...
public class ImageLoader {
	...
	private com.rahul.list.universalimageloader.core.ImageLoaderConfiguration configuration;
	private com.rahul.list.universalimageloader.core.ImageLoaderEngine engine;
	 ...
	 */
	public synchronized void init(com.rahul.list.universalimageloader.core.ImageLoaderConfiguration configuration) {
		if (configuration == null) {
			throw new IllegalArgumentException(ERROR_INIT_CONFIG_WITH_NULL);
		}
		if (this.configuration == null) {
			L.d(LOG_INIT_CONFIG);
			engine = new com.rahul.list.universalimageloader.core.ImageLoaderEngine(configuration);
	 ...
	 * @param imageAware {@linkplain com.rahul.list.universalimageloader.core.imageaware.ImageAware Image aware view}
	 ...
	 * @param imageAware {@linkplain com.rahul.list.universalimageloader.core.imageaware.ImageAware Image aware view}
	 *                   which should display image
	 * @param options    {@linkplain com.rahul.list.universalimageloader.core.DisplayImageOptions Options} for image
	 ...
	 * @throws IllegalArgumentException if passed <b>imageAware</b> is null
	 */
	public void displayImage(String uri, ImageAware imageAware, com.rahul.list.universalimageloader.core.DisplayImageOptions options) {
	 ...
	 * @param progressListener {@linkplain com.rahul.list.universalimageloader.core.listener.ImageLoadingProgressListener
	 *                         Listener} for image loading progress. Listener fires events on UI thread if this method
	 *                         is called on UI thread. Caching on disk should be enabled in
	 *                         {@linkplain com.rahul.list.universalimageloader.core.DisplayImageOptions options} to make
	 *                         this listener work.
	 * @throws IllegalStateException    if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 * @throws IllegalArgumentException if passed <b>imageAware</b> is null
	 */
	...
	public void displayImage(String uri, ImageAware imageAware, com.rahul.list.universalimageloader.core.DisplayImageOptions options,
		...
		if (bmp != null && !bmp.isRecycled()) {
			...
			if (options.shouldPostProcess()) {
				com.rahul.list.universalimageloader.core.ImageLoadingInfo imageLoadingInfo = new com.rahul.list.universalimageloader.core.ImageLoadingInfo(uri, imageAware, targetSize, memoryCacheKey,
						options, listener, progressListener, engine.getLockForUri(uri));
				com.rahul.list.universalimageloader.core.ProcessAndDisplayImageTask displayTask = new com.rahul.list.universalimageloader.core.ProcessAndDisplayImageTask(engine, bmp, imageLoadingInfo,
			...
			com.rahul.list.universalimageloader.core.ImageLoadingInfo imageLoadingInfo = new com.rahul.list.universalimageloader.core.ImageLoadingInfo(uri, imageAware, targetSize, memoryCacheKey,
					options, listener, progressListener, engine.getLockForUri(uri));
			com.rahul.list.universalimageloader.core.LoadAndDisplayImageTask displayTask = new com.rahul.list.universalimageloader.core.LoadAndDisplayImageTask(engine, imageLoadingInfo,
					defineHandler(options));
			if (options.isSyncLoading()) {
				displayTask.run();
			} else {
	 ...
	 * @throws IllegalArgumentException if passed <b>imageView</b> is null
	 */
	public void displayImage(String uri, ImageView imageView, com.rahul.list.universalimageloader.core.DisplayImageOptions options) {
	 ...
	 * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public void loadImage(String uri, com.rahul.list.universalimageloader.core.DisplayImageOptions options, ImageLoadingListener listener) {
	 ...
	 * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public void loadImage(String uri, ImageSize targetImageSize, com.rahul.list.universalimageloader.core.DisplayImageOptions options,
			ImageLoadingListener listener) {
	 ...
	 * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public Bitmap loadImageSync(String uri, com.rahul.list.universalimageloader.core.DisplayImageOptions options) {
	 ...
	 * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public Bitmap loadImageSync(String uri, ImageSize targetImageSize, com.rahul.list.universalimageloader.core.DisplayImageOptions options) {
		if (options == null) {
			options = configuration.defaultDisplayImageOptions;
		}
		options = new com.rahul.list.universalimageloader.core.DisplayImageOptions.Builder().cloneFrom(options).syncLoading(true).build();
	 ...
	 * {@link com.rahul.list.universalimageloader.core.imageaware.ImageAware ImageAware}
	 */
	 ...
	 * {@link com.rahul.list.universalimageloader.core.imageaware.ImageAware ImageAware}.
	 *
	 * @param imageAware {@link com.rahul.list.universalimageloader.core.imageaware.ImageAware ImageAware} for
	 ...
	 * {@linkplain com.rahul.list.universalimageloader.core.ImageLoaderConfiguration.Builder#taskExecutor(java.util.concurrent.Executor)
	...
	private static Handler defineHandler(com.rahul.list.universalimageloader.core.DisplayImageOptions options) {
