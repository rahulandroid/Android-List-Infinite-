...
import com.rahul.list.universalimageloader.cache.disc.naming.FileNameGenerator;
import com.rahul.list.universalimageloader.cache.memory.MemoryCache;
import com.rahul.list.universalimageloader.cache.memory.impl.FuzzyKeyMemoryCache;
...
import com.rahul.list.universalimageloader.core.assist.QueueProcessingType;
import com.rahul.list.universalimageloader.core.decode.ImageDecoder;
import com.rahul.list.universalimageloader.core.download.ImageDownloader;
import com.rahul.list.universalimageloader.core.process.BitmapProcessor;
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>diskCache = {@link com.rahul.list.universalimageloader.cache.disc.impl.UnlimitedDiskCache}</li>
	...
	public static class Builder {
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, com.rahul.list.universalimageloader.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		 ...
		 * {@link com.rahul.list.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.rahul.list.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.rahul.list.universalimageloader.cache.disc.impl.ext.LruDiskCache LruDiskCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(com.rahul.list.universalimageloader.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link com.rahul.list.universalimageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(com.rahul.list.universalimageloader.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link com.rahul.list.universalimageloader.cache.disc.impl.UnlimitedDiskCache
		 * UnlimitedDiskCache}. Cache directory is defined by
		 * {@link com.rahul.list.universalimageloader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Default value -
		 * {@link com.rahul.list.universalimageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.rahul.list.universalimageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Consider {@link com.rahul.list.universalimageloader.utils.L#disableLogging()} to disable
	 ...
	 * using {@link com.rahul.list.universalimageloader.core.assist.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
